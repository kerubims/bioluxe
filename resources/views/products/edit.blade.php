                ...
                <form method="POST" action="{{ route('products.update', $product) }}" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <x-text-input id="sku" name="sku" type="text" class="mt-1 block w-full bg-gray-100" :value="old('sku', $product->sku)" readonly />
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div>
                            ...
                            <x-text-input id="volume_ml" name="volume_ml" type="number" class="mt-1 block w-full" :value="old('volume_ml', $product->volume_ml)" required />
                        ...
                        <div>
                            ...
                            <select id="unit" name="unit" class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-green-500 dark:focus:border-green-600 focus:ring-green-500 dark:focus:ring-green-600 rounded-md shadow-sm" required>
                                ...
                                <option value="Jerigen" {{ old('unit', $product->unit) == 'Jerigen' ? 'selected' : '' }}>Jerigen</option>
                            </select>
                    ...
                    <div>
                        ...
                        <textarea id="description" name="description" class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-green-500 dark:focus:border-green-600 focus:ring-green-500 dark:focus:ring-green-600 rounded-md shadow-sm" rows="3">{{ old('description', $product->description) }}</textarea>
                    ...
                    <div class="block mt-4">
                        ...
                        <label for="is_active" class="inline-flex items-center">
                            <input id="is_active" type="checkbox" class="rounded dark:bg-gray-900 border-gray-300 dark:border-gray-700 text-green-600 shadow-sm focus:ring-green-500 dark:focus:ring-green-600 dark:focus:ring-offset-gray-800" name="is_active" value="1" {{ old('is_active', $product->is_active) ? 'checked' : '' }}>
